...
class Dashboard(BasePage):
    ...
    last_created_player_xpath = '//*[text()="Adam Kowalski"]'
    dev_team_contact_button_xpath = "//*[text()='Dev team contact']"
    last_created_player_path_xpath = "/html/body/div/div[1]/main/div[3]/div[3]/div/div/a[1]/button/span[1]"
    ...
    # def check_last_created_player(self, last_created_player):
    #     self.check_last_created_player(self.last_created_player_xpath)
    #     time.sleep(1)
    #     if last_created_player == "Adam Kowalski":
    #         print('Yahooo')
    #     else:
    #         print(':(')
